        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "This email has already been created");
                    }
                }
            }
            catch(Exception ex)
            {
                _logger.LogInformation("An unexpected error has occured while creating registration account", ex);

                ModelState.AddModelError(string.Empty, "Something went wrong while registering your email.");
            }
